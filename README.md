...
1. **Start with the Dashboard**
   - Open `dashboard.html`
   - Review the story from retention → risk → behavior → outcomes

2. **Review the ROI Model**
   - Open the Excel file
   - Adjust assumptions (cost, lift, members targeted)
   - Observe ROI impact across scenarios

3. **Connect Insights to Action**
   - Dashboard includes insights and 3 recommendations
   - All recommendations tie directly to measurable outcomes
...
- Engagement behaviors (steps, coaching, app usage, nudges) drive clinical outcomes
- Nudge responsiveness strongly correlates with HbA1c improvement

---

## Recommendations

1. Implement a **Day-21 intervention trigger** to prevent early disengagement  
2. Cap **High-Risk intervention cost at $300** to maintain ROI  
3. Promote **7,000 daily steps** as a key behavioral target  
